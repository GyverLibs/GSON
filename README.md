...
```cpp
// не хранить длину значения (экономит 2 байта на элемент, но замедляет чтения значения)
#define GSON_NO_LEN
```

#### Лимиты
- После парсинга один элемент весит 6-8 байт на AVR и 12 байт на ESP
...
- v1.3 - оптимизация парсера, ускорение чтения значений из Doc
